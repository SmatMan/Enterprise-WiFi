...
1. Plug the GLinet router into the wall with its associated plug. Use an ethernet cable from the laptop bag (or any cable) to connect either port from the back of the router to the ethernet port on the TV.
...
> You're done! The wifi connection should be all ready.
