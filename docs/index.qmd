...
[You're done!]{.mark} The wifi connection should be working fine now. The rest of the instructions should not be needed if you are *just* connecting a TV to the internet.
...
- Recompilation will be required in order to create a new APK to install the new credentials. Follow above. instructions
...
2. Download the **Command line tools only** for Mac
